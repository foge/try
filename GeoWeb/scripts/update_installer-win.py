...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=GeoWeb Demo Installer\n"
      else:
        line="OutputBaseFilename=GeoWeb Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the GeoWeb Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the GeoWeb installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=GeoWeb Demo installer\n"
     else:
       line="SetupWindowTitle=GeoWeb installer\n"
